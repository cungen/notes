...
- #马尔可夫链 ：序列$s_1\cdots s_t$ 具有马尔可夫性质，设状态历史为 $h_t={s_1,s_2,s_3,\cdots,s_t}$ ，则
$$
...
- ![https://datawhalechina.github.io/easy-rl/img/ch2/2.10.png|300](https://datawhalechina.github.io/easy-rl/img/ch2/2.10.png)
	- 最下面一层理解为下一个可能状态的价值
	- 中间为动作的价值
	- 最上面为当前状态的价值
